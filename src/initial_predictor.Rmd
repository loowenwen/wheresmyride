...
normalised_score <- function(features, 
  ...
  # Weighted score - subtract weighted congestion penalty
  final_score <- (score_mrt * norm_mrt +
                  score_bus * norm_bus +
                  walkability_score * norm_walk) - (congestion_penalty * norm_congestion)
...
result1 <- predict_accessibility("543305", weight_mrt = 50, weight_bus = 60, weight_walk = 40, selected_time_slots = c("AM_peak", "PM_peak"))
