...
shinyUI(
  fluidPage(
    ...
    titlePanel(
      div(
        h1("Public Transport Accessibility Dashboard", style = "text-align: center; font-weight: 700;"),
        h4("Empowering Smarter Location Decisions", style = "text-align: center; font-weight: 300; margin-bottom: 30px;"),
        style = "background-color: #e0f2fe; padding: 30px; border-radius: 16px;"
      )
    ),
