...
engineer_features <- function(lat, lon, distance = 2000) {
...
'
  ...
  if (num_mrt_stations == 0) {
    message("No MRT stations found within 2000m radius. MRT score may be low or NA.")
  }
  ...
  if (num_bus_stops == 0) {
    message("No bus stops found within 2000m radius. Bus score may be low or NA.")
  }
